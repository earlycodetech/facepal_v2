...
export default function SignIn() {
  ...
  const validationRules = yup.object().shape({
    email: yup.string().required('This field is compulsory').max(4 ,"This mustn't be more than 36"),
    password:yup.string().required().min(8).max(36,"This mustn't be more than 36").oneOf([yup.ref('passwordConfirmation'),null],'Your password must match')
  })
